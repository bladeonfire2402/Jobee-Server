...
const JobSchema = new mongoose.Schema({
    ...
    jobCategory: {type:mongoose.Schema.Types.ObjectId, ref: "Category", required: true },//danh mục công việc4
    ...
    jobApplied:[{ type: mongoose.Schema.Types.ObjectId, ref: "Application", required: false }],//danh sách người đã ứng tuyển
